...
export const TranslateIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5h12M9 3v2m4 13-4-4L5 17m0 0h12a2 2 0 002-2V9a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2z" />
  </svg>
);
...
export const EyeOffIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a10.052 10.052 0 013.453-5.051m5.23-1.816A10.026 10.026 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.05 10.05 0 01-2.063 4.025m-6.325-4.025a3 3 0 11-4.243-4.243m4.243 4.243l-4.243-4.243" />
    </svg>
);
...
export const FolderArrowDownIcon = ({ className }: { className?: string }) => (
